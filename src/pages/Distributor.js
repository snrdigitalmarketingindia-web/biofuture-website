...
const benefits = [
  { icon: '💰', title: 'High Margins', desc: 'Premium biodegradable segment commands 18–28% margins. Growing B2B demand across retail, food, hospitality and institutional sectors.' },
  { icon: '🏛️', title: 'DRDO Backing', desc: 'Sell with government-certified credibility. DRDO certification builds instant trust with buyers — especially institutional and corporate clients.' },
  { icon: '📈', title: 'Plastic Ban Tailwind', desc: 'Mandatory compliance driving demand across all industries. Fines and enforcement intensifying every year — your customers need to switch now.' },
  ...
  { icon: '🎨', title: 'Branded Products', desc: 'Custom printing available for your clients — bags with their store name, logo, and tagline. A value-add service that differentiates you from generic suppliers.' },
  { icon: '🤝', title: 'Full Onboarding Support', desc: 'Product training, sample packs, marketing materials, co-branded collateral, priority fulfillment, and dedicated account manager from day one.' },
];
...
const steps = [
  { num: '01', title: 'Submit Application', desc: 'Fill out the form below or message us on WhatsApp with your name, city, business type, and target volume.' },
...
export default function Distributor() {
  useEffect(() => {
    document.title = 'Become a Distributor | Biodegradable Packaging Dealer Program | RDN Bio Products';
    const m = document.querySelector('meta[name="description"]');
    if (m) m.content = 'Join RDN Bio Products as a biodegradable packaging distributor or dealer. DRDO certified products, exclusive territory, 18-28% margins. Pan India opportunity. Plastic ban is driving demand — partner with India\'s growing eco-packaging manufacturer.';
  }, []);
  ...
  return (
    <main>
      ...
      <section className="page-hero page-hero--dark">
        <div className="container">
          ...
          <p style={{ fontSize: 16, lineHeight: 1.75, marginBottom: 28, maxWidth: 620, color: 'rgba(255,255,255,0.92)' }}>
            India's plastic ban is creating a massive, mandatory market for biodegradable packaging. Join as a city, state, or pan India distributor and sell DRDO certified products that every business needs — with margins of 18–28% and exclusive territory protection.
          </p>
          ...
          <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
            {['✓ LLPIN ACI-9987', '✓ DRDO Certified', '✓ Pan India'].map(b => (
      ...
      <section style={{ padding: '56px 0', borderBottom: '1px solid #eef5e4' }}>
        <div className="container">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(260px,1fr))', gap: 20, marginTop: 32 }}>
            {benefits.map(b => (
              <div key={b.title} style={{ background: 'var(--green-pale)', border: '1px solid #d4e8b0', borderRadius: 16, padding: '24px 20px' }}>
                <div style={{ fontSize: 36, marginBottom: 12 }}>{b.icon}</div>
                <h3 style={{ fontSize: 16, fontWeight: 700, color: 'var(--green-dark)', marginBottom: 8 }}>{b.title}</h3>
                <p style={{ fontSize: 13, color: '#666', lineHeight: 1.7 }}>{b.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section style={{ padding: '56px 0', background: '#f0f9e8', borderBottom: '1px solid #d4e8b0' }}>
        <div className="container">
          <h2 className="section-title" style={{ textAlign: 'center' }}>Regional &amp; Territory Model</h2>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(240px,1fr))', gap: 24, marginTop: 36 }}>
            {tiers.map(t => (
              <div key={t.title} style={{
                ...
                <div style={{ marginBottom: 14 }}>
                  <div style={{ fontSize: 11, fontWeight: 700, textTransform: 'uppercase', letterSpacing: 1, opacity: 0.75, marginBottom: 4 }}>Min Order Qty</div>
                ...
                <div style={{ marginBottom: 20 }}>
                  ...
                  <div style={{ fontSize: 22, fontWeight: 800 }}>{t.margin}</div>
                </div>
                <a href="#dist-application" style={{
                  ...
                  color: (t.dark || t.highlight) ? '#fff' : '#fff',
      ...
      <section style={{ padding: '56px 0', borderBottom: '1px solid #eef5e4' }}>
        <div className="container">
          <h2 className="section-title" style={{ textAlign: 'center' }}>Onboarding Process</h2>
      ...
      {/* Application Form */}
      <section id="dist-application" style={{ padding: '56px 0', background: 'var(--green-pale)', borderBottom: '1px solid #d4e8b0' }}>
        <div className="container">
          <h2 className="section-title" style={{ textAlign: 'center' }}>Apply as a Distributor</h2>
          <p className="section-sub" style={{ textAlign: 'center' }}>Fill the form below — we'll respond via WhatsApp within 24 hours on business days</p>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(300px,1fr))', gap: 40, marginTop: 36, alignItems: 'start' }}>
            ...
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                ...
                <div style={{ background: '#fff', border: '1px solid #d4e8b0', borderRadius: 12, padding: '18px 20px', fontSize: 13, color: '#666', lineHeight: 1.7 }}>
